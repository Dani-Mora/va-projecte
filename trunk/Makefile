...
widget/$(MAKEFILE): 
	...
	cd widget/ && $(QMAKE) /dades/daniel.mora.de.checa/linux/va/va-projecte/widget/widget.pro -spec /usr/share/qt4/mkspecs/linux-g++-32 CONFIG+=debug -o $(MAKEFILE)
...
app/$(MAKEFILE): 
	...
	cd app/ && $(QMAKE) /dades/daniel.mora.de.checa/linux/va/va-projecte/app/app.pro -spec /usr/share/qt4/mkspecs/linux-g++-32 CONFIG+=debug -o $(MAKEFILE)
