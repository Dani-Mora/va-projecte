...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Wed Oct 3 11:40:01 2012
# Project:  main.pro
# Template: subdirs
# Command: /usr/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++-32 CONFIG+=debug -o Makefile main.pro
#############################################################################
...
widget/$(MAKEFILE): 
	...
	cd widget/ && $(QMAKE) /dades/andreu.marimon/linux/Documentos/VA/va-projecte/widget/widget.pro -spec /usr/share/qt4/mkspecs/linux-g++-32 CONFIG+=debug -o $(MAKEFILE)
...
app/$(MAKEFILE): 
	...
	cd app/ && $(QMAKE) /dades/andreu.marimon/linux/Documentos/VA/va-projecte/app/app.pro -spec /usr/share/qt4/mkspecs/linux-g++-32 CONFIG+=debug -o $(MAKEFILE)
...
Makefile: main.pro  /usr/share/qt4/mkspecs/linux-g++-32/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++-32 CONFIG+=debug -o Makefile main.pro
